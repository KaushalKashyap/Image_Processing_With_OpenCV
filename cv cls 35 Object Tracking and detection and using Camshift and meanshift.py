...
#The idea behind this algo is to move small window(set of pixels of objects) to get the high 
...
import numpy as np
import cv2 as cv
cap = cv.VideoCapture('C:\\Users\\RANGER\\Desktop\\Roadside.mp4')
...
import numpy as np
import cv2 as cv
cap = cv.VideoCapture('C:\\Users\\RANGER\\Desktop\\Parking.mp4')
